! function (e) {
    ...
    ! function (t, n) {
        ...
        var k = function (e) {
            ...
            try {
                B.apply(O = P.call(b.childNodes), b.childNodes), O[b.childNodes.length].nodeType
            } catch (t) {
                B = {
                ...
                if (!i && ((t ? t.ownerDocument || t : b) !== f && p(t), t = t || f, m)) {
                    if (11 !== w && (d = $.exec(e)))
                        if (o = d[1]) {
                            ...
                            if ((o = d[3]) && n.getElementsByClassName && t.getElementsByClassName) return B.apply(r, t.getElementsByClassName(o)), r
                        ...
                        try {
                            return B.apply(r, v.querySelectorAll(y)), r
                        } catch (t) {
                            k(e, !0)
                        } finally {
            ...
            for (t in n = se.support = {}, o = se.isXML = function (e) {
                    ...
                    return a !== f && 9 === a.nodeType && a.documentElement && (h = (f = a).documentElement, m = !o(f), b !== f && (i = f.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", oe, !1) : i.attachEvent && i.attachEvent("onunload", oe)), n.attributes = le(function (e) {
                        ...
                        h.appendChild(e).innerHTML = "<a id='" + A + "'></a><select id='" + A + "-\r\\' msallowcapture=''><option selected=''></option></select>", e.querySelectorAll("[msallowcapture^='']").length && g.push("[*^$]=" + U + "*(?:''|\"\")"), e.querySelectorAll("[selected]").length || g.push("\\[" + U + "*(?:value|" + D + ")"), e.querySelectorAll("[id~=" + A + "-]").length || g.push("~="), e.querySelectorAll(":checked").length || g.push(":checked"), e.querySelectorAll("a#" + A + "+*").length || g.push(".#.+[+~]")
                    }), le(function (e) {
                        ...
                        return r || (1 & (r = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !n.sortDetached && t.compareDocumentPosition(e) === r ? e === f || e.ownerDocument === b && x(b, e) ? -1 : t === f || t.ownerDocument === b && x(b, t) ? 1 : l ? I(l, e) - I(l, t) : 0 : 4 & r ? -1 : 1)
                    } : function (e, t) {
                        if (e === t) return d = !0, 0;
                        var n, r = 0,
                            i = e.parentNode,
                            ...
                            a = [e],
                            s = [t];
                        if (!i || !o) return e === f ? -1 : t === f ? 1 : i ? -1 : o ? 1 : l ? I(l, e) - I(l, t) : 0;
                ...
                return r && !r[A] && (r = Te(r)), i && !i[A] && (i = Te(i, o)), ue(function (o, a, s, c) {
                    ...
                    if (o) {
                        if (i || e) {
                            ...
                            for (l = y.length; l--;)(d = y[l]) && -1 < (u = i ? I(o, d) : p[l]) && (o[u] = !(a[u] = d))
                        }
                    } else y = we(y === a ? y.splice(h, y.length) : y), i ? i(null, a, y, c) : B.apply(a, y)
                })
            }
                ...
                if (!g) {
                    ...
                    (g = C(e, (i = h, s = 0 < (o = d).length, c = 0 < i.length, l = function (e, t, n, a, l) {
                        ...
                        if (y += v, s && v !== y) {
                            ...
                            B.apply(a, A), l && !e && 0 < A.length && 1 < y + o.length && se.uniqueSort(a)
                        }
                        return l && (w = E, u = b), x
                    }, s ? ue(l) : l))).selector = e
                }
                ...
                if (n = n || [], 1 === f.length) {
                    ...
                    for (o = z.needsContext.test(e) ? 0 : c.length; o-- && (u = c[o], !r.relative[l = u.type]);)
                        if ((d = r.find[l]) && (i = d(u.matches[0].replace(te, ne), ee.test(c[0].type) && ye(t.parentNode) || t))) {
                            if (c.splice(o, 1), !(e = i.length && xe(c))) return B.apply(n, i), n;
                            break
                        }
                }
        ...
        E.filter = function (e, t, n) {
            ...
            is: function (e) {
                return !!B(this, "string" == typeof e && O.test(e) ? E(e) : e || [], !1).length
            }
        });
        var P, I = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
        ...
        E.fn.extend({
            ...
            E.fn[e] = function (n, r) {
                ...
                return "Until" !== e.slice(-5) && (r = n), r && "string" == typeof r && (i = E.filter(r, i)), 1 < this.length && (U[e] || E.uniqueSort(i), D.test(e) && i.reverse()), this.pushStack(i)
            }
        });
        var F = /[^\x20\t\r\n\f]+/g;
        ...
        function He(e, t, n, r) {
            ...
            var i, o, a, s, c, l, d = 0,
                ...
                h = t[0],
                m = v(h);
            if (m || 1 < p && "string" == typeof h && !y.checkClone && Ie.test(h)) return e.each(function (i) {
                var o = e.eq(i);
            ...
            if (p && (o = (i = Ee(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
                ...
                if (s)
                    ...
                    }) : b(c.textContent.replace(De, ""), c, l))
            }
            return e
        }
        ...
        E.param = function (e, t) {
            ...
            serializeArray: function () {
                return this.map(function () {
                    ...
                    var e = this.type;
                    return this.name && !E(this).is(":disabled") && Bt.test(this.nodeName) && !Mt.test(e) && (this.checked || !me.test(e))
                }).map(function (e, t) {
                    var n = E(this).val();
        ...
        Kt.href = kt.href, E.extend({
            ...
            ajax: function (e, t) {
                ...
                for (p in (d = E.event && h.global) && 0 == E.active++ && E.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !Ft.test(h.type), i = h.url.replace(Dt, ""), h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(It, "+")) : (f = h.url.slice(i.length), h.data && (h.processData || "string" == typeof h.data) && (i += (Lt.test(i) ? "&" : "?") + h.data, delete h.data), !1 === h.cache && (i = i.replace(Ut, "$1"), f = (Lt.test(i) ? "&" : "?") + "_=" + Rt++ + f), h.url = i + f), h.ifModified && (E.lastModified[i] && T.setRequestHeader("If-Modified-Since", E.lastModified[i]), E.etag[i] && T.setRequestHeader("If-None-Match", E.etag[i])), (h.data && h.hasContent && !1 !== h.contentType || t.contentType) && T.setRequestHeader("Content-Type", h.contentType), T.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + Gt + "; q=0.01" : "") : h.accepts["*"]), h.headers) T.setRequestHeader(p, h.headers[p]);
                ...
                (function (t) {
                    ...
                    o.prototype = {
                        ...
                        D: function () {
                            ...
                            P(G, "setTimeout", e, r), P(G, "setInterval", e, r), G.requestAnimationFrame && P(G, "requestAnimationFrame", function (e) {
                                return function (t) {
                                    return e(n.wrap({
                                        mechanism: {
                                            type: "instrument",
                        ...
                        E: function () {
                            ...
                            if (n.location && a) {
                                ...
                                P(G.history, "pushState", c, r), P(G.history, "replaceState", c, r)
                            }
                        ...
                        _makeRequest: function (e) {
                            var t = e.url + "?" + R(e.auth),
                                n = null,
                                r = {};
                            if (e.options.headers && (n = this.sa(e.options.headers)), e.options.fetchParameters && (r = this.sa(e.options.fetchParameters)), I()) {
                                r.body = s(e.data);
                                var i = T({}, this.l),
                                    o = T(i, r);
    ...
    ! function () {
        ...
        if (!(t && t.length > 0)) {
            ...
            if (r(27), !0 !== s.disable) {
                var l, d = "cyxy-trs-source",
                    ...
                    h = "cyxy-target-count",
                    m = "cyxy-no-trs",
                    g = (s.token, "小译火力全开！LingoCloud, FIRE!"),
                    y = "+30 彩云朵！现有：",
                    v = "限免次数已不足，成为小译注册用户，畅享更多阅读次数！现在注册还送彩云朵哟~",
                    x = "诶呦喂~彩云朵不足！修订译文或点击赞、分享赚取彩云朵，或购买VIP畅享无限阅读次数",
                    A = "抱歉，网页认证有误，请刷新重试",
                    b = "抱歉，网络请求有误，请刷新重试",
                    w = "提交有误",
                    T = "感谢点赞，+5 彩云朵！",
                    ...
                    U = 2300,
                    j = "b";
                (location.host.indexOf("wx.qq.com") >= 0 || location.host.indexOf("slack.com") >= 0) && (U = 1e3), location.host.indexOf("youtube.com") >= 0 && (U = 500), "local" != s.ENV && n.config("https://c49231b0334e4624b8941767b8f6bfa4@sentry.in.caiyunapp.com/22", {
                    release: s.VERSION,
                    environment: s.ENV,
                    sampleRate: 1
                }).install();
                        ...
                        try {
                            ...
                            ! function () {
                                ...
                                t.className = "cyxy-target-popup " + d, t.innerHTML = '<div style="margin: auto"><img id="cyxy-popup-left-slide" src="https://caiyunapp.com/imgs/webtrs/left-slide.png"> <div id="cyxy-popup-userinfo"><img id="cyxy-popup-avatar" src="https://caiyunapp.com/imgs/xiaoyilogo.jpg" /> <div id="cyxy-popup-name-time"> <span id="cyxy-popup-name">彩云小译</span> <span id="cyxy-popup-time">刚刚</span></div></div><div id="cyxy-popup-favour"><img id="cyxy-popup-favour-img" src="https://caiyunapp.com/images/favour.png"><span id="cyxy-popup-favour-num">0</span></div><img id="cyxy-popup-right-slide" src="https://caiyunapp.com/imgs/webtrs/right-slide.png"></div>', document.body.appendChild(t), u(".cyxy-target-popup").hide(), u("#cyxy-popup-left-slide").hide(), u("#cyxy-popup-right-slide").hide(), u(".cyxy-target-popup").click(function () {}), u(document).mouseup(function (e) {
                                    ...
                                    if (u("#cyxy-popup-favour").hasClass("commit")) P && (l.data("before") !== l.text() ? l.data("user_s_id") ? function (t, n, r, i) {
                                        if (!H) {
                                            ae();
                                            var a = s.TRS_URL + "/v1/page/" + M + "/sentence/" + n;
                                            H = !0, chrome.runtime.sendMessage({
                                                method: "POST",
                                                ...
                                                if ("ok" != t.status) throw H = !1, o.open({
                                                    content: w,
                                                    skin: "msg",
                                                    time: 3
                                        ...
                                        if (u("#cyxy-popup-favour").removeClass("commit"), e && 0 == e.rc) {
                                            ...
                                            l.data("targetInfo", t);
                                            var n = l.data("targetList");
                                            n && n.length > 0 && l.data("targetList", n.concat(t)), i = "", a = "", c = "、", (r = u("#cyxy-footer-translator").text()).indexOf(B.username) < 0 && (r || (c = "", i = "和", a = "共同"), u("#cyxy-footer-translator").text(i + B.username + c + r + a)), "android" == F ? window.js.showEditSuccess("", y + e.point.total_point) : "ios" == F ? window.webkit.messageHandlers.showEditSuccess.postMessage({
                                                title1: "",
                                                title2: y + e.point.total_point
                                            }) : o.open({
                                                content: "" + y + e.point.total_point,
                                                skin: "msg",
                                                time: 3
                                            })
                                        } else o.open({
                            ...
                            }(), c.preload([s.XIAOYI_DEFAULT_URL, s.FAVOR_IMG_URL, s.CHECKED_IMG_URL, s.LEFT_SLIDE_URL, s.RIGHT_SLIDE_URL]), "share" == F ? (new i).get(function (e, t) {
                                    O = e, V()
                                }) : a.testCookie(function (e) {
                                    var t, n, r;
                                    e ? (t = P = e._id, n = function (e) {
                                        B = e, e && !e.avatar_url && (B.avatar_url = s.DEFAULT_AVATAR_URL), B.biz.is_xy_vip && (I = "1"), V()
                                    }, r = s.TRS_URL + "/v1/user/" + t, chrome.runtime.sendMessage({
                                        method: "POST",
                                        contentScriptQuery: "fetchUrl",
                                        url: r,
                                        headers: {
                                        ...
                                        if ("ok" == e.status) {
                                            ...
                                            0 == t.rc ? (n(t.user), t.user.avatar_url && u(".cyxy-personal .cyxy-favorite-btn").attr("src", t.user.avatar_url)) : o.open({
                                ...
                                function () {
                                    chrome.storage.sync.get({
                                        ...
                                        if (e.targetBkgColor) {
                                            var t = u(`<style>.${f} { background-color: ${e.targetBkgColor}; }</style>`);
                                            u("html > head").append(t)
                                        }
                                    });
                                    var e = u(".cyxy-function >img");
                                    u(".cyxy-function").click(function () {
                                        "b" == j ? (j = "s", e.attr("src", "https://www.caiyunapp.com/imgs/webtrs/mode-s.png"), u("." + f + ":not('.cyxy-no-trs')").hide(), K()) : "s" == j ? (j = "t", e.attr("src", "https://www.caiyunapp.com/imgs/webtrs/mode-t.png"), G(), u("." + f).show()) : "t" == j && (j = "b", e.attr("src", "https://www.caiyunapp.com/imgs/webtrs/fanyi-btn-hover.png"), K(), u("." + f).show())
                                    });
                                    var t = !1;
                                    u(".cyxy-favorite").click(function () {
                                        t || a.postFavorite(document.URL, P, function (e) {
                                            0 == e.rc ? (o.open({
                                                type: 4,
                                                ...
                                                time: 8,
                                                skin: "msg"
                                            }), $("#cyxyFavoriteBtn").attr("src", "https://caiyunapp.com/imgs/webtrs/favorite-on-btn.png"), t = !0) : o.open({
                                                content: "收藏失败",
                                                skin: "msg",
                                                time: 3
                                            })
                ...
                window.cyPageMark = function () {
                    var e = c.wordStatistics(document.body),
                        t = Math.round(((new Date).getTime() - q.getTime()) / 1e3),
        ...
        function G() {
            u("." + f).prev(":not('.cyxy-no-trs')").hide();
            for (var e = document.getElementsByClassName(f), t = 0; t < e.length; t++) {
        ...
        function X() {
            document.URL.indexOf("slack.com") >= 0 || location.origin + location.pathname != D && (V(), D = location.origin + location.pathname)
        }
                ...
                0 == y.rc ? w >= 0 && (o.open({
                    ...
                    if (!(t && t.length > 5)) {
                        ...
                        setInterval(function () {
                            x(document.body), b()
                        }, U), Y(20), x(document.body), Y(40), b(), Y(80), window.onscroll = function (e) {
                            ...
                            }), e ? a.fetchPageSentenceTargetList(e, P, M, function (e) {
                                if (0 == e.rc) {
                                    var t, n = e.sentence;
                                    if (n && n.length > 0) {
                                        l.data("index", 0), u("#cyxy-popup-left-slide").hide(), l.data("targetList", n);
                                        for (var r = 0, i = n.length; r < i; r++) n[r] && (n[r].user && P == n[r].user.id && (l.data("user_s_id", n[r].id), l.data("user_index", r)), n[r].invalid && (n.splice(r, 1), r--));
                            ...
                            }) : (l.data("targetList", []), u("#cyxy-popup-left-slide").hide(), u("#cyxy-popup-right-slide").hide(), u("#cyxy-popup-avatar").attr("src", s.XIAOYI_DEFAULT_URL), u("#cyxy-popup-name").text(S), u("#cyxy-popup-time").text(C), u("#cyxy-popup-favour-num").text("0"), u("#cyxy-popup-favour-img").attr("src", s.FAVOR_IMG_URL), u(this).data("xiaoyiText", u(this).text()));
                            ...
                            return u(this).data("before") !== u(this).text() && (l.data("status", "edit"), u("#cyxy-popup-avatar").attr("src", B.avatar_url), u("#cyxy-popup-name").text(B.username), u("#cyxy-popup-time").text(R), u("#cyxy-popup-favour-num").text(k), u("#cyxy-popup-favour-img").attr("src", s.CHECKED_IMG_URL), u("#cyxy-popup-favour").addClass("commit"), u("#cyxy-popup-oppose-num").text("0")), u(this)
                        }).on("blur focusout", "." + f + "[contenteditable]", function () {
                            return null !== _ && clearTimeout(_), _ = setTimeout(function () {
                    ...
                    function x(e) {
                        if (!("SCRIPT" == e.nodeName || "LINK" == e.nodeName || "STYLE" == e.nodeName || "CODE" == e.nodeName || "NOSCRIPT" == e.nodeName || "CITE" == e.nodeName || e.classList && (e.classList.contains(d) || e.classList.contains(m) || e.classList.contains(f) || e.classList.contains("qq_face") || e.classList.contains("msg_input_wrapper") || e.classList.contains("prettyprint") || e.classList.contains("PROGRAMLISTING"))))
                            for (var t = e.childNodes, o = 0, a = t.length; o < a; o++) {
                                var s = t[o];
                                s && (s.classList && (s.classList.contains(d) || s.classList.contains(f)) || (s.classList && (s.classList.contains("js_message_plain") || s.classList.contains("message_body")) ? u(t[o]).children("." + f).length > 0 || (A(s), r.push(s)) : "PRE" != s.nodeName && (s.classList && s.classList.contains("captions-text") ? s.firstElementChild && s.firstElementChild.classList.contains(d) || (s.childNodes && s.childNodes.forEach(function (e, t) {
                                    re(e, d)
                                }), w([s], "sub")) : "P" != s.nodeName ? !(Z(s) && s.nodeName.indexOf("H") >= 0) || "H1" != s.nodeName && "H2" != s.nodeName && "H3" != s.nodeName && "H4" != s.nodeName && "H5" != s.nodeName && "H6" != s.nodeName || s.firstElementChild && ("SPAN" == s.firstElementChild.nodeName || "SPAN" == s.lastElementChild.nodeName || "A" == s.firstElementChild.nodeName || "A" == s.lastElementChild.nodeName) || s.parentElement && "A" == s.parentElement.nodeName ? s.nodeType === Node.TEXT_NODE && ee(s) ? (re(s.parentElement, d), v.push(s)) : s.nodeType === Node.ELEMENT_NODE && x(s) : (re(s, d), i.push(s)) : (re(s, d), n.push(s)))))
                            }
                    }
                    ...
                    function w(e, t) {
                        for (var n = [], r = [], i = [], o = [], a = [], s = [], u = [], l = [], d = [], p = 0, f = e.length; p < f; p++) {
                            var h = e[p],
                                m = "";
                            try {
                                m = "text" == t ? h.nodeValue : h.innerText || h.innerHTML.replace(/& lt;.+?>/gim, "")
                            } catch (e) {
                                continue
                            }
                            if (m = m.trim()) {
                        ...
                        if (!(i.length <= 0)) {
                            ...
                            "ja2zh" == r ? (l = "ja2zh", d = s.TRS_URL + "/v1/page/translator") : "zh2en" == r && (l = "zh2en", d = s.TRS_URL + "/v1/page/translator"), chrome.runtime.sendMessage({
                                ...
                                data: {
                                    source: i,
                                    trans_type: l,
                                    request_id: P || N || O || "web-translate",
                                    url: document.URL,
                                    page_id: M,
                                    replaced: !0,
                                    cached: s.CACHED
                                ...
                                if (a && 0 == a.rc) {
                                    ...
                                    for (var c = 0, l = t.length; c < l; c++) {
                                        ...
                                        if (s[c] && s[c].target) {
                                            m = s[c].target.trim();
                                            var g = i[c];
                                            if (i[c].trim().toLowerCase() !== m.toLowerCase()) {
                                                var y = 0;
                                                s[c].sentence_id && (y = s[c].sentence_id);
                                                var v = s[c].count || 0,
                                                    x = null;
                                                if ("p" == n) {
                                                    if ((x = d.cloneNode(!0)).innerText = m, P && m.length > 4 && (x.contentEditable = !0), re(x, f), x.sentence_id = y, x.source_text = g, v > 1)(A = document.createElement("span")).className = h, A.innerText = "(" + v + ")", x.appendChild(A);
                                                    d.parentNode.insertBefore(x, d.nextSibling)
                                                } else if ("pre" == n) {
                                                    if ("" != (x = u(d).children("." + f)[0]).innerText) continue;
                                                    m = ne(m), P && m.length > 4 && (x.contentEditable = !0), x.sentence_id = y, x.source_text = te(d.innerText), x.innerText = " " + m
                                                } else if ("h" == n) {
                                                    if (m = ne(m), (x = d.cloneNode(!0)).innerText = m, P && m.length > 4 && (x.contentEditable = !0), x.sentence_id = y, x.source_text = te(d.innerText), re(x, f), v > 1)(A = document.createElement("span")).className = h, A.innerText = "(" + v + ")", x.appendChild(A);
                                                    d.parentNode.insertBefore(x, d.nextSibling)
                                                } else if ("sub" == n) m = ne(m), sourceClone = d.firstElementChild.cloneNode(!0), targetClone = d.firstElementChild.cloneNode(!0), targetClone.firstChild.innerText = m, re(targetClone, f), d.appendChild(targetClone);
                                                else {
                                                    if (m = ne(m), i[c].trim().toLowerCase() === m.toLowerCase()) continue;
                                                    var A;
                                                    if (re(x = document.createElement("font"), f), P && m.length > 4 && "A" != d.parentNode.nodeName && (x.contentEditable = !0), x.sentence_id = y, x.source_text = te(d.nodeValue), d.source = d.nodeValue, v > 1)(A = document.createElement("span")).className = h, A.innerText = "(" + v + ")", sp.appendChild(A);
                                                    x.innerText = " " + m, d.parentNode.insertBefore(x, d.nextSibling)
                                                }
                                                "ja2zh" == r && re(x, "colored"), "sub" != n && re(d, p)
                                            }
                                        }
                                    }
                                    "s" == j ? u("." + f + ":not('.cyxy-no-trs')").hide() : "t" == j && G()
                                }
                            })
                        }
                    }
                    ...
                    ! function (t) {
                        ae();
                        var n = s.TRS_URL + "/v1/page/" + M + "/author";
                        chrome.runtime.sendMessage({
                            method: "POST",
                            contentScriptQuery: "fetchUrl",
                            url: n,
                            ...
                            if (0 == n.rc) {
                                ...
                                var l = 6e3;
                                "和" == a && u(".cyxy-footer").show(), "share" == F && (u(".cyxy-footer").show(), u(".cyxy-footer").click(function () {
                        ...
                        0 == t.rc && t.coupon && (localStorage.setItem("cy_coupon_code", JSON.stringify({
                            ...
                            function (e) {
                                var t = "",
                                    n = "",
                                    r = "";
                                e.coupon_code && e.device_id && (t = "?coupon_code=" + e.coupon_code + "&device_id=" + e.device_id, n = e.coupon_code, r = e.coupon_code), "android" == F ? window.js.showLoginDialog(v, r) : "ios" == F ? window.webkit.messageHandlers.showLoginDialog.postMessage({
                                    title: v,
                                    coupon_code: n
                    ...
                    className: m,
                    content: v + "<a class='login-hint-a' href='https://support.qq.com/products/107129/faqs/57979' target='_blank'>一直无法登录？请看常见问题</a>",
                    btn: ["登录", "取消"],
                    yes: function (e) {
                    ...
                    btn: ["成为VIP", "取消"],
                    yes: function (e) {
                        a.alipayForOneMonthRedeem(P, function (e) {
        ...
        function z(t, n, r, i, a) {
            if (!H) {
                ae();
                var c = s.TRS_URL + "/v1/page/" + M + "/sentence",
                    u = P;
                a && (u = a), H = !0, chrome.runtime.sendMessage({
                    method: "POST",
                    contentScriptQuery: "fetchUrl",
                    url: c,
                    headers: {
        ...
        function Q(t, n, r, i) {
            if (!H) {
                H = !0, n = n.toUpperCase();
                var a = s.TRS_URL + "/v1/page/" + M + "/sentence/" + t + "/comment";
                chrome.runtime.sendMessage({
                    method: "POST",
                    contentScriptQuery: "fetchUrl",
                    url: a,
        ...
        function Y(e) {
            "android" == F && window.js.changeProgress(e)
        }
        ...
        function oe(e) {
            if (e && e.parentElement) return ie(e.parentElement)
        }
    ...
    function f() {
        for (let e = 0, t = l.length; e < t; e++) r(`.cyxy-${l[e]}`).stop().fadeOut(i * e);
        r(".cyxy-ctrl-wrapper").css({
            height: "50px"
        }), chrome.storage.sync.set({
            btnGroupShow: !1
    ...
    r("body").append(d), r(".cyxy-options-btn").click(function () {
        chrome.runtime.sendMessage({
            tag: "options"
        })
        ...
        1 == e.isFirst ? (p(), o = !1, u = setTimeout(() => {
            f(), o = !0
        }, 8e3), chrome.storage.sync.set({
            isFirst: !1
        })) : e.btnGroupShow ? (p(), o = !1) : (f(), o = !0)
        ...
        r("body").append(`<div class="cyxy-video-hint cyxy-no-trs">${chrome.i18n.getMessage("videoTrans")}</div>`), r(".cyxy-video-hint").attr("style", "transform: translateY(-50%) !important;")
    }), r(".cyxy-options-link").on("mouseenter", function () {
        r("body").append(`<div class="cyxy-options-hint cyxy-no-trs">${chrome.i18n.getMessage("optionsPage")}</div>`), r(".cyxy-options-hint").attr("style", "transform: translateY(-50%) !important;")
    }), r(".cyxy-ctrl-btn").on("mouseenter", function () {
        r(".cyxy-ctrl-hint").remove(), r("body").append(`<div class="cyxy-ctrl-hint cyxy-no-trs">${chrome.i18n.getMessage("ctrlHint")}</div>`), r(".cyxy-ctrl-hint").attr("style", "transform: translateY(-50%) !important;")
